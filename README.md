...
- **Google Tasks 연동**: 분석된 업무를 Google Tasks API를 통해 자동으로 등록합니다.
...
```
2. Google Cloud Console에서 데스크톱 앱용 OAuth 클라이언트 ID를 생성하여 `credentials.json` 파일로 다운로드 후 프로젝트 루트 폴더에 배치합니다.
